// ! puedes extraer los interfaces o tipos directamente por ejemplo colocando el json generado de una api como la de pokemon, y pegandolo en la herramienta llamda "quicktype.io"
// ! también puedes usar la extension de vscode. lo usas a través de la command palette
